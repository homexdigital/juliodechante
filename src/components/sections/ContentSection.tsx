...
export default function ContentSection({ id, heading, children, tone = "default" }: ContentSectionProps) {
  return (
    <section
      ...
      className={tone === "muted" ? "bg-cream-dark/50" : undefined}
    >
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <div className="prose prose-neutral mt-6 max-w-none prose-headings:font-heading prose-headings:text-primary prose-a:text-primary">
          {children}
        </div>
      </div>
    </section>
