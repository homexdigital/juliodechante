    ...
    <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6">
      <div className="rounded-3xl bg-gradient-to-br from-navy-dark to-surface px-6 py-12 text-center ring-1 ring-primary/30 sm:px-12">
        ...
        <a
          ...
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-7 py-3.5 text-base font-bold text-cream transition-colors hover:bg-primary-dark"
        >
